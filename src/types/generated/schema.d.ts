...
export interface paths {
    "/demos": {
        ...
        get: operations["get/demos"];
        put?: never;
        post: operations["post/demos"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/demos/{id}": {
        ...
        get: operations["get/demos/{id}"];
        put: operations["put/demos/{id}"];
        post?: never;
        delete: operations["delete/demos/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/directories": {
        ...
        get: operations["get/directories"];
        put?: never;
        post: operations["post/directories"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/directories/{id}": {
        ...
        get: operations["get/directories/{id}"];
        put: operations["put/directories/{id}"];
        post?: never;
        delete: operations["delete/directories/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/terms/{id}": {
        ...
        get: operations["get/terms/{id}"];
        put: operations["put/terms/{id}"];
        post?: never;
        delete: operations["delete/terms/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        DemoRequest: {
            data: {
                name?: string;
                meanings?: components["schemas"]["DynamicMeaningComponent"][];
                /** @example string or id */
                user?: number | string;
            };
        };
        DemoListResponseDataItem: {
            id?: number;
            attributes?: components["schemas"]["Demo"];
        };
        DemoListResponse: {
            data?: components["schemas"]["DemoListResponseDataItem"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        DemoResponseDataObject: {
            id?: number;
            attributes?: components["schemas"]["Demo"];
        };
        DemoResponse: {
            data?: components["schemas"]["DemoResponseDataObject"];
            meta?: Record<string, never>;
        };
        DynamicMeaningComponent: {
            id?: number;
            text?: string;
        };
        DirectoryRequest: {
        ...
        DirectoryListResponseDataItem: {
            id?: number;
            attributes?: components["schemas"]["Directory"];
        };
        DirectoryListResponse: {
            data?: components["schemas"]["DirectoryListResponseDataItem"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        DirectoryResponseDataObject: {
            id?: number;
            attributes?: components["schemas"]["Directory"];
        };
        DirectoryResponse: {
            data?: components["schemas"]["DirectoryResponseDataObject"];
            meta?: Record<string, never>;
        };
        TermRequest: {
            data: {
                value: string;
                meanings: components["schemas"]["DynamicMeaningComponent"][];
                examples?: components["schemas"]["DynamicMeaningComponent"][];
                /** @example string or id */
                user?: number | string;
                /** @example string or id */
        ...
        TermListResponseDataItem: {
            id?: number;
            attributes?: components["schemas"]["Term"];
        };
        TermListResponse: {
            data?: components["schemas"]["TermListResponseDataItem"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        TermResponseDataObject: {
            id?: number;
            attributes?: components["schemas"]["Term"];
        };
        TermResponse: {
            data?: components["schemas"]["TermResponseDataObject"];
            meta?: Record<string, never>;
        };
        UploadFile: {
            id?: number;
    ...
    "get/demos": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DemoListResponse"];
                };
            };
